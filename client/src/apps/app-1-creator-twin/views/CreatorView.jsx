 ...
 * Shows controls bar, creator context card, swipeable video, creator comment panel
 * with Edit/Approve, metrics bar, and "How it works" section.
 */
export default function CreatorView({
  ...
  const hasCustomContext =
    (creatorContext.notes && creatorContext.notes.trim().length > 0)
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-4 space-y-4">
        ...
        {/* Metrics bar */}
        <MetricsBar personaId={personaId} />
